...
class Mother {
    ...
    die(){
        ...
        //!!! ԿԱՐԵՎՈՐ !!! ջնջում է ինքն իրեն խոտակերների զանգվածից
        for (var i in MomArr) {
            if (this.x == MomArr[i].x && this.y == MomArr[i].y) {
                MomArr.splice(i, 1);
            }
        }
    }
